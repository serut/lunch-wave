		...
		each(axis.series, function (series) {
			...
			if (series.visible || !chart.options.chart.ignoreHiddenSeries) {
				...
				// Get dataMin and dataMax for Y axes, as well as handle stacking and processed data
					...
					// if the processData haven't been called on this series, because the order of axis put the y axis before the x axis
					if(typeof(series.processedXData)=='undefined'){
						series.processData()
					}
